...
void solve_lp(lemon::ListGraph *,lemon::ListGraph::EdgeMap<double> *,lemon::ListGraph::EdgeMap<double> *, RequirementFunction*, lemon::ListGraph::EdgeMap<int> *, lemon::ListGraph::Edge *, double*, bool );    
